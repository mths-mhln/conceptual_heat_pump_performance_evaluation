...
refrigerant = "R1234ze(E)"  # [-] - "R1234ze(Z)", "MM" "R1234ze(E)"
...
ts_margin_T_top   = 0.25  # fraction of T-span added top - for R1234ze(Z)/MM best is 0.15, for R1234ze(E) best is 0.25
